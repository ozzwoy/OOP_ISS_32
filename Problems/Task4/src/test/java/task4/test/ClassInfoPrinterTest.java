...
import task4.main.class_info_printer.ClassInfoPrinter;
...
public class ClassInfoPrinterTest {
    ...
    public void testOnInterface() throws ClassNotFoundException {
        ClassInfoPrinter printer = new ClassInfoPrinter("task4.test.sample_classes.Duck");
        printer.print();
        String output = outData.toString().trim().replace("\r", "");
        Assertions.assertTrue(output.contains("public abstract interface task4.test.sample_classes.Duck") &&
    ...
    public void testOnClass() throws ClassNotFoundException {
        ClassInfoPrinter printer = new ClassInfoPrinter("task4.test.sample_classes.DuckImpl");
        printer.print();
        String output = outData.toString().trim().replace("\r", "");
        Assertions.assertTrue(output.contains("public class task4.test.sample_classes.DuckImpl") &&
                output.contains("extends java.lang.Object implements task4.test.sample_classes.Duck") &&
