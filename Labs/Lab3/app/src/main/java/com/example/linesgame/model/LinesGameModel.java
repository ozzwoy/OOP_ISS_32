...
public class LinesGameModel {
    ...
    public LinesGameModel(int fieldSize) throws InvalidFieldSizeException {
        if (fieldSize < 5) {
    ...
    public LinesGameModel(int fieldSize, ComputerStrategy computerStrategy)
